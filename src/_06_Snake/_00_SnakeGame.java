...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	public void startGame() {
		...
		String instructions = "Grow and collect food and dont crash into yourself or da walls....";
	...
	private void setFoodLocation() {
		...
		Location loca = new Location(rand.nextInt(_00_SnakeGame.WIDTH), rand.nextInt(_00_SnakeGame.HEIGHT));
		...
		while (snake.isLocationOnSnake(foodLocation)) {
			loca = new Location(rand.nextInt(_00_SnakeGame.WIDTH), rand.nextInt(_00_SnakeGame.HEIGHT));
		}
		foodLocation = loca;
	}
	...
	private void gameOver() {
		...
		int playAgain = JOptionPane.showConfirmDialog(null, "Do you wanna play again??", "Play again!",
